    ...
    for (const auto &target : ai_msg->targets) {
      ...
      if (1 == track_cfg_.activate_wakeup_gesture) {
        ...
        if (static_cast<int>(GestureCtrlType::Awesome) != found_gesture &&
            ...
            static_cast<int>(GestureCtrlType::Mute) != found_gesture &&
            static_cast<int>(GestureCtrlType::Okay) != found_gesture &&
...
void GestureControlEngine::RunStrategy(
  ...
  if (static_cast<int>(GestureCtrlType::Awesome) != track_info_.gesture &&
      ...
      static_cast<int>(GestureCtrlType::Mute) != track_info_.gesture &&
      static_cast<int>(GestureCtrlType::Okay) != track_info_.gesture &&
  ...
  if (static_cast<int>(GestureCtrlType::Awesome) == track_info_.gesture) {
    ...
    DoRotate(static_cast<int>(GestureDirectionType::LEFT),
             track_cfg_.rotate_step);
    return;
  }else if (static_cast<int>(GestureCtrlType::Mute) ==
             track_info_.gesture) {
    // rotate left
    DoMove(static_cast<int>(GestureDirectionType::M_LEFT),
             track_cfg_.rotate_step);
    return;
  }else if (static_cast<int>(GestureCtrlType::Okay) ==
             track_info_.gesture) {
    // rotate left
    DoMove(static_cast<int>(GestureDirectionType::M_RIGHT),
             track_cfg_.rotate_step);
    return;
  }
